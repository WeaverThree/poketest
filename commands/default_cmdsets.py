...
class CharacterCmdSet(default_cmds.CharacterCmdSet):
    ...
    def at_cmdset_creation(self):
        ...
        self.add(chargen.CmdChargen())
        self.add(chargen.CmdChargenBuyEVs())
        ...
        self.add(chargen_admin.CmdChargenAdminSetInfo())
        self.add(chargen_admin.CmdChargenAdminSetSex())
